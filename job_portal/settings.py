...
SECRET_KEY = 'django-insecure-=q8&%@49yu#&x9&fzb((7bic5qr9h-!quja4v1^_y6#uf^j7rq'
...
#Django Custom Automatic Reload
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/proImage')  # Directory for uploaded media files
